  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <button onClick={handleWhatsApp}
        className="w-full py-3.5 text-[11px] tracking-[1px] font-medium flex items-center justify-center gap-2 text-white rounded-sm"
      ...
      <div style={{borderTop:"1px solid #EDE6DC",paddingTop:"16px",marginTop:"4px"}}>
        ...
        <div style={{fontSize:"11px",color:"#A09890",textAlign:"center",marginTop:"10px"}}>
